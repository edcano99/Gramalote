...
datosrutas = $('#datosrutas').DataTable({ 
 ...
 "columns":[
     ...
     "render": function ( data, type, fullI, meta ) {
            var id_rutas = fullI.id_rutas;

          // var capacitacion = fullI.nom_capacitacion;
         return "<div class='text-center'><div class='btn-group'><button class='btn btn-link bi-trash btnBorrar ' value='"+id_rutas+"' id =''>Eliminar</button></div></div>";
     }
          },
 ],
